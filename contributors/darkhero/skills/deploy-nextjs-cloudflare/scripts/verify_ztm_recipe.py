...
ORCHESTRATOR_MARKERS = {
    ...
    "resident_auth_adapter": "sso_browser.py",
    "authenticated_receipt_read_back": 'out.read_text(encoding="utf-8")',
    ...
    "cycle_phase_reset": 'for phase in ("SCF", "AEX", "SEAL")',
    "cycle_phase_pending": 'entry.update({"phase": phase, "state": "PENDING"})',
