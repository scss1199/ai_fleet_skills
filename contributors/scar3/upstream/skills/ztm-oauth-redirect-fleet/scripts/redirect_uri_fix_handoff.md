...
Source of truth: `redirect_uri_state.json` schema 2, probed 2026-08-12T16:55:54+0800.
1 site(s) need a console ADD across 1 OAuth client(s); 0 blocked site(s) cannot be fixed in the console.
...
Green — registered, origin matches, verified by this probe run: `ai-busker`, `ai-career`, `ai-darkhero`, `ai-eatery`, `ai-fracdigi`, `ai-jci-taipei`, `ai-search`, `ai-ut`, `ai-ziyaoastro`
